...
import { LineToolPaneView, SegmentRenderer, TextRenderer, AnchorPoint, deepCopy, LineEnd, BoxVerticalAlignment, BoxHorizontalAlignment, TextAlignment, PaneCursorType, BaseLineTool, merge, InteractionPhase, Point } from 'lightweight-charts-line-tools-core';
 ...
 */
class LineToolPriceRangePaneView extends LineToolPaneView {
    /**
    ...
    constructor(source, chart, series) {
         ...
         * @protected
         */
        this._arrowLineRenderer = new SegmentRenderer();
        /**
         * Internal renderer specifically for the dynamic price difference label.
         * @protected
         */
        this._priceDifferenceLabelRenderer = new TextRenderer();
    }
    /**
    ...
    _updateImpl(height, width) {
        ...
        const topLineRenderer = new SegmentRenderer();
        ...
        const bottomLineRenderer = new SegmentRenderer();
 ...
 */
class LineToolPriceRange extends BaseLineTool {
    /**
...
export { LineToolPriceRange, registerPriceRangePlugin as default, registerPriceRangePlugin };
//# sourceMappingURL=lightweight-charts-line-tools-price-range.js.map
